...
object Movement extends core.BitcoinDB {
  ...
  private def get[T <: Column[_]](f: core.Movements => T, from: Int, until: Int)(implicit wt: scala.slick.lifted.CanBeQueryCondition[T]) =
  ...
  private def getSummary[T <: Column[_]](f: core.Movements => T)(implicit wt: scala.slick.lifted.CanBeQueryCondition[T]) =
    transactionDBSession {
